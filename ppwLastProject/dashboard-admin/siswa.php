    ...
    <div class="row">
        ...
        <div class="col-12 col-xl-9">
                ...
                <div class="d-flex justify-content-between align-items-center nav-input-container">
                    <div class="nav-input-group">
                        <form action="" method="post" class="d-flex justify-content-between w-100">
                            <input type="text" class="nav-input text-black fst-normal" placeholder="Cari Orang" autofocus name="keyword">
            ...
            <div class="content">
                <div class="row">
                    <div class="col-12">
                        <h2 class="content-title">Lihat Seluruh Siswa</h2>
                        <h5 class="content-desc mb-4">Read and delete student</h5>
                    </div>
                    <div class="col-12">
                        <?php
                        if (isset($_GET['msg'])) {
                                ...
                                <?php
                                    ...
                                    foreach ($siswa as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href='delete.php?id=".$value['id_siswa']."'><i class='fa fa-trash'></i></a>"."</td>
                                        </tr>
                                        ";
                                        $no++;
