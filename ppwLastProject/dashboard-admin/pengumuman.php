    ...
    <div class="row">
        <div class="col-12 col-lg-3 col-navbar d-none d-xl-block">
            ...
            <aside class="sidebar">
                ...
                <a href="./pengumuman.php" class="sidebar-item active" onclick="toggleActive(this)">
            ...
            <div class="nav">
                <div class="d-flex justify-content-between align-items-center w-100 mb-3 mb-md-0">
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <h2 class="nav-title">Pengumuman</h2>
                    </div>
                    <a href="./addpengumuman.php" target="_blank">
            ...
            <div class="content">
                <div class="row">
                    <div class="col-12">
                        ...
                        <h5 class="content-desc mb-4">Buat dan hapus Pengumuman</h5>
                    </div>
                </div>
                <?php
                    if (isset($_GET['msg'])) {
                ...
                <div class="col-12">
                    <div class="document-card">
                        <?php
                            ...
                            // foreach untuk menampilkan data pengumuman
                            foreach ($pengumuman as $value) {
                                echo '
                                <div class="document-item">
                                    <div class="d-flex justify-content-start align-items-center">
                                        <div class="d-flex flex-column justify-content-between align-items-start">
                                            <h2 class="document-title">'.$value["nama_pengumuman"].'</h2>
                                            <span class="document-desc">'.$value["tanggal"].'</span>
                                            <p>'.$value["isi"].'</p>
                                            <a href="delete_pengumuman.php?id='.$value["id_pengumuman"].'"><i class="fa fa-trash"></i></a>
                                        </div>
                                    </div>
                                </div>
                                ';
