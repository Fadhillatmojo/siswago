    ...
    <div class="row">
        <div class="col-12 col-lg-3 col-navbar d-none d-xl-block">
            ...
            <aside class="sidebar">
                ...
                <a href="./statistik.php" class="sidebar-item active" onclick="toggleActive(this)">
                ...
                <a href="./Materi.php" class="sidebar-item" onclick="toggleActive(this)">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="./pengumuman.php" class="sidebar-item" onclick="toggleActive(this)">
                    <!-- <img src="./assets/img/global/pengumuman.png" alt="" width="24" height="24"> -->
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="col-12 col-xl-9">
            <div class="nav">
                <div class="d-flex justify-content-between align-items-center w-100 mb-3 mb-md-0">
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <h2 class="nav-title">Kelas</h2>
                    </div>
                    <a href="./addclass.php" target="_blank">
                ...
                <div class="d-flex justify-content-between align-items-center nav-input-container">
                    <div class="nav-input-group">
                        <form action="" method="post" class="d-flex justify-content-between w-100">
                            <input type="text" class="nav-input text-black fst-normal" placeholder="Cari Kelas" autofocus name="keyword">
                            <button class="btn-nav-input"name="cari"><img src="./assets/img/global/search.svg" alt=""></button>
                        </form>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-12">
                        <h2 class="content-title">Lihat, tambah, edit, dan hapus kelas</h2>
                        <h5 class="content-desc mb-4">(Hapus kelas akan membuat semua siswa dalam 1 kelas ikut terhapus)</h5>
                    </div>
                    <div class="col-12">
                        <?php
                        if (isset($_GET['msg'])) {
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    // tombol cari ditekan
                                    if (isset($_POST['cari'])) {
                                        $kelas = cari_kelas($_POST['keyword'], $conn);
                                    }
                                    $no = 1;
                                    foreach ($kelas as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href='update_class.php?id=".$value['id_kelas']."'><i class='fa fa-pencil-square'></i></a>"."
                                            <a href='delete_class.php?id=".$value['id_kelas']."'><i class='fa fa-trash'></i></a>"."</td>
                                        </tr>
                                        ";
                                        $no++;
